...
/**
 * No runtime invariant: the plugin owns one controller and two slot
 * registrations, all released by the same effect disposer, and the board's
 * durable invariants are owned by `@deepseek-ai/dsh-task-board` on the Host.
 */
