...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-task-board': { kind: 'none', reason: 'Browser-side kanban over the task-board sidecar; cards, transitions, and activity never enter the Session log, model context, or telemetry.' },
  ...
  'packages/credentials/credentials-bcrypt': { kind: 'indirect', reason: 'The sealing service stores and checks digests; consumers of ctx.credentials own any model-facing behavior a verified value authorizes.' },
